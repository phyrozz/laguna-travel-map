...
const About = () => {
    return (
        <div className="about-container">
            ...
            <p>This map let's you show your travel status around the province of Laguna, Philippines. You can play around with the map by clicking on each municipality then choosing which travel status fits on that place.</p>
            ...
            <p>So hey, while we're at it, here's also a breakdown of different cities and municipalities present on this map:</p>
            <table>
                <tr>
